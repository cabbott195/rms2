...
router.get('/catalog/create', ir_controller.ir_GET);

// // POST request for creating IR.
router.post('/catalog/create', ir_controller.ir_POST);
...
// router.get('/catalog/updated', updatedIrs_controller.updateIr_GET);

// // // POST request to update IR.
// router.post('/catalog/updated', updatedIrs_controller.updateIr_POST);
